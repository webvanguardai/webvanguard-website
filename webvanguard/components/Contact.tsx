...
export default function Contact() {
  return (
    <section id="contact" className="py-section relative overflow-hidden">
      {/* Background accent */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-accent/[0.03] rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[90rem] mx-auto px-6 md:px-12 relative z-10">
        <div className="border-t border-border pt-section">
          ...
          >
            <a href="mailto:hello@webvanguard.ai" className="group relative border border-border bg-bg-card p-8 overflow-hidden transition-all duration-500 hover:border-accent/50">
              ...
              <svg className="w-5 h-5 text-text-muted group-hover:text-accent transition-all duration-300 mt-6 group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </a>

            <a href="https://wa.me/971501234567" target="_blank" rel="noopener noreferrer" className="group relative border border-border bg-bg-card p-8 overflow-hidden transition-all duration-500 hover:border-accent/50">
              <div className="absolute top-0 left-0 w-full h-[2px] bg-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
            ...
            <div className="group relative border border-border bg-bg-card p-8 overflow-hidden transition-all duration-500 hover:border-accent/50">
              <div className="absolute top-0 left-0 w-full h-[2px] bg-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
              ...
              <p className="text-text-muted text-sm mt-6 group-hover:text-text-secondary transition-colors duration-300">Working with businesses worldwide</p>
            </div>
          </motion.div>
