        ...
        >
          ...
          >
            <a
              ...
              className="text-gray-400 hover:text-accent-hover transition-colors duration-300 font-sans text-sm uppercase tracking-wider"
            >
          ...
          <motion.div
            ...
            className="mt-12 pt-8 border-t border-gray-900 text-center md:text-left"
          >
